...
public class Assert {
    ...
    public static void notNull(Object obj, ResponseEnum responseEnum) {
        if(obj == null){
            ...
            throw new BlogException(responseEnum);
        }
    }
     ...
     * @param responseEnum
     */
    public static void gtValue(Integer resource, Integer target, ResponseEnum responseEnum) {
        if (resource > target) {
            throw new BlogException(responseEnum);
        }
    }
     ...
     * @param responseEnum
     */
    public static void ltValue(Integer resource, Integer target, ResponseEnum responseEnum) {
        if (resource < target) {
            throw new BlogException(responseEnum.getMessage());
        }
    }
}
